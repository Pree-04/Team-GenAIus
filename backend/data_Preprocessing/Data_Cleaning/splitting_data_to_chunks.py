...
def split_file(input_file, output_dir, lines_per_file=500):
    ...
    for i, chunk in enumerate(chunks[:13]):  # Create 13 chunks
...
# Example usage
input_file = "C:/Users/preet/Downloads/GenAIus/all_extracted_data.txt"
output_dir = "C:/Users/preet/Downloads/GenAIus/Data Pre processing"
